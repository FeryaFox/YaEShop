...
public class ProductPublicController {
    ...
    public ResponseEntity<ProductInfoResponse> getProduct(
            @PathVariable @Parameter(description = "Идентификатор продукта", required = true) String productId
    ) {
    ...
    public ResponseEntity<?> getStore(
            @PathVariable @Parameter(description = "Идентификатор магазина", required = true) String shopId,
            @RequestParam(name = "page", defaultValue = "0") @Parameter(description = "Номер страницы для пагинации", example = "0") int page,
            @RequestParam(name = "size", defaultValue = "10") @Parameter(description = "Размер страницы для пагинации", example = "10") int size
    ) {
    ...
    public ResponseEntity<?> searchProductsByName(
            @RequestParam(name = "name") @Parameter(description = "Название продукта или его часть", required = true) String name,
            @RequestParam(name = "page", defaultValue = "0") @Parameter(description = "Номер страницы для пагинации", example = "0") int page,
            @RequestParam(name = "size", defaultValue = "10") @Parameter(description = "Размер страницы для пагинации", example = "10") int size
    ) {

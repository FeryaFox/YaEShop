...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleReviewNotFoundException(ReviewIsNotExistsException ex) {
    ...
    public ResponseEntity<Map<String, String>> handleReviewAlreadyExistsException(ReviewAlreadyExistsException ex) {
        log.warn("Ошибка: {}", ex.getMessage());
        return buildResponse(HttpStatus.CONFLICT, "review_already_exists", ex.getMessage());
    }

    // Ошибка: продукт не найден
    @ExceptionHandler(ProductIsNotExistsException.class)
    public ResponseEntity<Map<String, String>> handleProductNotFoundException(ProductIsNotExistsException ex) {
        log.warn("Ошибка: {}", ex.getMessage());

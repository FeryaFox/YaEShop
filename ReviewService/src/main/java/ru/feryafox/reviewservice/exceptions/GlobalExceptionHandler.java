...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleReviewNotFoundException(ReviewIsNotExistsException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleProductNotFoundException(ProductIsNotExistsException ex) {
        log.warn("Ошибка: {}", ex.getMessage());

...
public class PaymentController {
    ...
    public ResponseEntity<?> awaitingPayment(
            ...
            @Parameter(description = "Детали аутентифицированного пользователя") UserDetails userDetails
    ) {
    ...
    public ResponseEntity<Void> processPayment(
            @PathVariable @Parameter(description = "Идентификатор платежа") String paymentId
    ) {
